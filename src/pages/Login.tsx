        ...
        >
          ...
          <div className="relative rounded-2xl p-8 backdrop-blur-xl border border-border bg-card/80">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Google button */}
              {isWebView ? (
                <div className="rounded-xl border border-warning/30 bg-warning/5 p-3 text-center space-y-2">
                  <p className="text-xs text-warning font-medium">
                    O login com Google não funciona neste navegador interno.
                  </p>
                  <button
                    type="button"
                    onClick={() => {
